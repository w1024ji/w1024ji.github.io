...
Below I want to summarize how this project is far, and what I want to do next.
Since this worked only for a single, simple data, I am looking forward to work with a MASSIVE DATA - about weather - !!
